...
const Pagination: React.FC<PaginationProps> = ({ currentPage, totalPages, onPageChange, rowsPerPage, onRowsPerPageChange }) => {
 ...
 <span className="text-[10px] font-black text-gray-600 dark:text-gray-300 uppercase tracking-[0.2em]">Rows per page</span>
 ...
 : 'text-gray-500 dark:text-gray-400 hover:text-dark dark:hover:text-white hover:bg-gray-50 dark:hover:bg-white/5'
 }`}
 >
 {limit}
 </button>
 ...
 : 'bg-white dark:bg-black/20 text-gray-600 dark:text-gray-300 border-gray-100 dark:border-white/5 hover:border-brand/40 dark:hover:border-brand/40 shadow-sm'
 }`}
 >
 {page}
 </button>
 ) : (
 <span key={index} className="w-10 h-10 flex items-center justify-center text-gray-500 dark:text-gray-400 font-black">
 {page}
 </span>
 )
 ))}
 ...
 <span className="text-[10px] font-black text-gray-600 dark:text-gray-300 uppercase tracking-[0.2em]">
