...
const DividendManagement: React.FC<DividendManagementProps> = ({ lang }) => {
 ...
 return (
 <div className="compact-screen space-y-10 animate-in fade-in duration-700">
 <Toast
 ...
 <th className="px-10 py-6 text-left text-[11px] font-black text-gray-600 dark:text-gray-400 uppercase tracking-widest">{t('transactions.date', lang)}</th>
 <th className="px-10 py-6 text-left text-[11px] font-black text-gray-600 dark:text-gray-400 uppercase tracking-widest">{t('transactions.description', lang)}</th>
 <th className="px-10 py-6 text-left text-[11px] font-black text-gray-600 dark:text-gray-400 uppercase tracking-widest">{t('dividends.recipient', lang)}</th>
 <th className="px-10 py-6 text-right text-[11px] font-black text-gray-600 dark:text-gray-400 uppercase tracking-widest">{t('dividends.payout', lang)}</th>
 <th className="px-10 py-6 text-right text-[11px] font-black text-gray-600 dark:text-gray-400 uppercase tracking-widest">{t('transactions.status', lang)}</th>
 </tr>
 </thead>
