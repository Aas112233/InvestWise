...
const Header: React.FC<HeaderProps> = ({ user, onLogout, isDarkMode, toggleTheme, lang, setLang }) => {
  ...
  return (
    <header className="h-[90px] bg-[#F8FAFC] dark:bg-[#111814] flex items-center justify-between px-10 border-b border-gray-100 dark:border-white/5 transition-colors duration-300">
      ...
      <div className="flex items-center gap-6 ml-10">
        ...
        <div className="flex items-center gap-3 pl-6 border-l border-gray-200 dark:border-white/10">
          ...
          <img 
            src={user.avatar} 
            className="w-12 h-12 rounded-2xl border-2 border-white dark:border-white/10 shadow-sm" 
            alt="Profile" 
          />
          <button 
            onClick={onLogout}
