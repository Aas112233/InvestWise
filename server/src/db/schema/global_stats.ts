...
export const globalStatsTrends = pgTable('global_stats_trends', {
  ...
  index('idx_stats_trends_stats_id').on(table.globalStatsId),
  index('idx_stats_trends_month').on(table.month),
]);
...
export const globalStatsSectors = pgTable('global_stats_sectors', {
  ...
  index('idx_stats_sectors_stats_id').on(table.globalStatsId),
]);
