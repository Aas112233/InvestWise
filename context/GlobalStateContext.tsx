...
export const GlobalStateProvider: React.FC<{ children: React.ReactNode; user: User | null }> = ({ children, user }) => {
 ...
 try {
 // Fetch all core data in parallel for performance
 await Promise.all([
 fetchMembers(),
 fetchProjects(),
 fetchFunds(),
 ...
 // Don't throw - partial data is better than no data
 }
 };
 ...
 refreshData, refreshAllData, distributeDividends, transferEquity, transferFunds, reconcileFund
 }}>
 {children}
