...
const ConnectionBanner: React.FC = () => {
    ...
    useEffect(() => {
        ...
        // Removed "degraded" status warnings - no banner or toast for slow connections
    ...
    // Only show banner for offline status, hide for degraded/slow connections
    ...
    return (
        <>
            <div className={`w-full py-2 px-4 flex items-center justify-between text-sm font-medium z-[50] ${isOffline
