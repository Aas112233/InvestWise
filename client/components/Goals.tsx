...
const Goals: React.FC<GoalsProps> = ({ lang }) => {
 ...
 value={goals.length}
 icon={<div className="p-2.5 bg-purple-50 dark:bg-purple-900/20 rounded-2xl text-purple-600 dark:text-purple-400"><Target size={18} /></div>}
 />
 <SummaryMetricCard
 label={t('goals.stats.achieved', lang)}
 value={totalAchieved}
 icon={<div className="p-2.5 bg-green-50 dark:bg-green-900/20 rounded-2xl text-green-600 dark:text-green-400"><CheckCircle2 size={18} /></div>}
 />
 <SummaryMetricCard
 label={t('goals.stats.inProgress', lang)}
 value={totalInProgress}
 icon={<div className="p-2.5 bg-blue-50 dark:bg-blue-900/20 rounded-2xl text-blue-600 dark:text-blue-400"><TrendingUp size={18} /></div>}
 />
 <SummaryMetricCard
 label={t('goals.stats.totalTarget', lang)}
 value={`৳ ${Math.round(totalTarget / 1000)}k`}
 valueClassName="text-2xl sm:text-3xl"
 icon={<div className="p-2.5 bg-orange-50 dark:bg-orange-900/20 rounded-2xl text-orange-600 dark:text-orange-400"><DollarSign size={18} /></div>}
 />
 </div>
