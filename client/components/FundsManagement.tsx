...
const FundsManagement: React.FC<FundsManagementProps> = ({ lang }) => {
 ...
 <div className="inline-flex p-6 bg-gray-100 dark:bg-white/10 rounded-full text-gray-500 dark:text-gray-300 mb-4">
 <Wallet size={48} />
 </div>
 <h3 className="text-xl font-black text-dark dark:text-white">No Active Funds</h3>
 <p className="text-gray-500 dark:text-gray-400 mt-2">Create a new fund to start tracking assets.</p>
 </div>
 )}
 </div>
