...
const Header: React.FC<HeaderProps> = ({ user, onLogout, isDarkMode, toggleTheme, lang, setLang }) => {
 ...
 />
 <div className="absolute right-5 top-1/2 -translate-y-1/2 flex items-center gap-1 bg-gray-100 dark:bg-white/10 px-2 py-1 rounded-md border border-gray-200 dark:border-white/10 text-[10px] font-bold text-gray-600 dark:text-gray-300">
 <Command size={10} />
 <span>F</span>
 </div>
 </div>
